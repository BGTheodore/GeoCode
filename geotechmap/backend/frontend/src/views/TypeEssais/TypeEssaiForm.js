            ...
            <CCol xs="12" sm="6">
              <CCard>
                  ...
                  Informations sur le type d'essai  {  match.params.id}
                    ...
                    <CCardBody>
                      <CFormGroup>
                        <TextField label="Description:" type="textarea" name="description" placeholder="Entrer la description du type d'essai.." autoComplete="description"/>
                        <CFormText className="help-block">Veuillez entrer la description du type d'essai</CFormText>
                      </CFormGroup>      
                    </CCardBody>
                    <CCardFooter>
